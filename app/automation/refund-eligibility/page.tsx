      ...
      <main>
        <div className="max-w-4xl mx-auto px-4 sm:px-8 py-16">
          ...
          <h1 className="text-3xl sm:text-4xl font-light text-foreground mb-12">
            <span className="font-medium text-accent">Refund Eligibility Assessment System</span>
          </h1>
          ...
          <div className="space-y-12">
            ...
            <div>
              ...
              <div className="grid sm:grid-cols-3 gap-6">
                <div className="text-center py-6 border-b border-border">
                  <div className="text-2xl font-medium text-accent mb-2">3,000+</div>
            ...
            <div>
              ...
              <div className="space-y-2 text-sm text-muted-foreground">
                <p>
                  <span className="font-medium text-foreground">Stack:</span> Zapier, OpenAI API, Stripe API, Zendesk
                </p>
                <p>
